...
var (
	errUnspecifiedFailure      = errors.New("vmet: unspecified failure")
	errOutOfMemory             = errors.New("vmet: out of memory")
	errInvalidArgument         = errors.New("vmet: invalid argument provided")
	...
	errNotAuthorized           = errors.New("vnet: not authorized")
